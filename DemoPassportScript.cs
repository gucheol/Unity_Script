...
public class DemoPassportScript : MonoBehaviour
{
    ...
    string[] seg_list = new string[] {"PassportInnerSynth"};
    float[][] seg_color_list = new float[][] {PresetColor.object_background};
    ...
    void Update()
    {
        ...
        else
        {
            ...
            if (frame_index % 3 == 2)
            {
                ...
                filename = String.Format("BoundingBox_{0}.json", frame_index / 3);
    ...
    void CreatePassportShape(string cover_path, string inner_path)
    {
        ...
        Vector3 location = new Vector3(3.5f, 0f, 9f);
        Vector3 rotation = new Vector3(0, -90f, 0);
        inner_obj.transform.localPosition = location;
        inner_obj.transform.rotation = Quaternion.Euler(rotation);
        //
    ...
    void MakejsonTextList(List<string> extractNames)
    {
        ...
        addNames = new List<string>() { "Mr1", "Mr2", "SurName", "Type", "PassportNo", "Issue", "Expiry" };
